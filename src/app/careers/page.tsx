    ...
    <div className="relative bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen">
      ...
      <section className="relative w-full bg-gradient-to-br from-blue-100 via-white to-blue-200 py-28 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 flex flex-col items-center text-center relative z-10">
          ...
          <a href="#devops-internship" className="inline-block bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-400 text-white font-bold px-8 py-3 rounded-full shadow-lg hover:scale-105 transition text-lg glow-effect animate-bounce">View Internship Program</a>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-blue-800 mb-4">Apply for the Internship Program</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Ready to start your DevOps journey? Fill out the application form below and we&apos;ll get back to you within 24 hours.
            </p>
          </div>
          <ContactForm 
            title="Apply for the Internship Program"
            subtitle="Fill out the form below and we'll get back to you within 24 hours."
            defaultPosition="DevOps and Cloud Internship Program 2025"
            emailSubject="Career Application - DevOps Internship"
            emailTo="careers@octobit8.com"
            showCompany={false}
            placeholder="Tell us about your background, experience, and why you're interested in this position..."
          />
        </div>
      </section>
    </div>
