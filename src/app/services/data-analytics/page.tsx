    ...
    <div className="relative bg-gradient-to-br from-blue-50 via-white to-blue-100 min-h-screen">
      ...
      <section className="relative w-full bg-gradient-to-br from-blue-100 via-white to-blue-200 py-28 px-4 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 flex flex-col items-center text-center relative z-10">
          <span className="inline-block bg-blue-600 text-white font-semibold px-4 py-1 rounded-full text-sm tracking-widest mb-4 animate-pulse">Data Analytics</span>
          <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-4 drop-shadow-lg text-gray-900">Unlock Insights, Drive <span className="text-blue-700">Business Growth</span></h1>
          <p className="text-lg md:text-xl font-medium text-gray-700 mb-6 max-w-2xl">We help you collect, process, and visualize data to drive smarter business decisions and accelerate growth.</p>
          <Link href="/contact" className="inline-block bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-400 text-white font-bold px-8 py-3 rounded-full shadow-lg hover:scale-105 transition text-lg glow-effect animate-bounce">Get a Data Assessment</Link>
        </div>
      </section>
      {/* Why Choose Us */}
      <section className="max-w-4xl mx-auto mb-16 px-4 relative">
        <div className="bg-white rounded-2xl shadow-lg p-10 border-l-8 border-blue-500 flex flex-col items-center relative z-10">
          ...
          <p className="text-lg text-gray-700 text-center">Our certified data engineers and analysts deliver end-to-end data solutions, from strategy to implementation, with a focus on business value and ROI.</p>
        </div>
      </section>
      {/* Core Offerings */}
          ...
          <div className="flex flex-col gap-12">
            <div className="relative group flex flex-col items-stretch bg-white rounded-2xl shadow-xl border-l-8 border-blue-500 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl">
              <div className="flex flex-col items-center justify-center min-w-[120px] bg-gradient-to-b from-blue-600 to-blue-400 p-8 md:p-10">
                ...
                <span className="text-white font-bold text-lg tracking-wide">Data Warehousing & ETL</span>
              </div>
              <div className="flex-1 p-8 md:p-10">
                <h3 className="text-2xl font-bold text-blue-700 mb-2">Centralized, Reliable Data</h3>
                <p className="text-gray-700 mb-4">Build scalable data pipelines and warehouses for clean, accessible, and actionable data.</p>
              </div>
            </div>
            <div className="relative group flex flex-col items-stretch bg-white rounded-2xl shadow-xl border-l-8 border-green-500 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl">
              <div className="flex flex-col items-center justify-center min-w-[120px] bg-gradient-to-b from-green-600 to-green-400 p-8 md:p-10">
                <Image src="/icons/dashboard.svg" alt="Dashboard" width={64} height={64} className="w-16 h-16 mb-4 drop-shadow-lg" />
                <span className="text-white font-bold text-lg tracking-wide">BI & Dashboards</span>
              </div>
              <div className="flex-1 p-8 md:p-10">
                <h3 className="text-2xl font-bold text-blue-700 mb-2">Business Intelligence</h3>
                <p className="text-gray-700 mb-4">Interactive dashboards and reports for real-time insights and decision-making.</p>
              </div>
            </div>
          </div>
          <div className="flex flex-col gap-12">
            <div className="relative group flex flex-col items-stretch bg-white rounded-2xl shadow-xl border-l-8 border-yellow-500 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl">
              <div className="flex flex-col items-center justify-center min-w-[120px] bg-gradient-to-b from-yellow-500 to-yellow-300 p-8 md:p-10">
                <Image src="/icons/ml.svg" alt="ML" width={64} height={64} className="w-16 h-16 mb-4 drop-shadow-lg" />
                <span className="text-white font-bold text-lg tracking-wide">Predictive Analytics</span>
              </div>
              <div className="flex-1 p-8 md:p-10">
                <h3 className="text-2xl font-bold text-blue-700 mb-2">Machine Learning & Forecasting</h3>
                <p className="text-gray-700 mb-4">Leverage ML models for forecasting, segmentation, and advanced analytics.</p>
              </div>
            </div>
            <div className="relative group flex flex-col items-stretch bg-white rounded-2xl shadow-xl border-l-8 border-pink-500 overflow-hidden transition-transform duration-300 hover:-translate-y-1 hover:shadow-2xl">
              <div className="flex flex-col items-center justify-center min-w-[120px] bg-gradient-to-b from-pink-600 to-pink-400 p-8 md:p-10">
                <Image src="/icons/cloud.svg" alt="Cloud Data" width={64} height={64} className="w-16 h-16 mb-4 drop-shadow-lg" />
                <span className="text-white font-bold text-lg tracking-wide">Cloud Data Solutions</span>
              </div>
              <div className="flex-1 p-8 md:p-10">
                <h3 className="text-2xl font-bold text-blue-700 mb-2">Cloud & Hybrid Analytics</h3>
                <p className="text-gray-700 mb-4">Deploy analytics on AWS, Azure, or GCP for scalability, security, and cost efficiency.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center">
            ...
            <ul className="list-disc list-inside text-gray-700 mb-4 text-left">
              ...
              <li>Financial forecasting & risk analysis</li>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col items-center">
            ...
            <ul className="list-disc list-inside text-gray-700 mb-4 text-left">
              ...
              <li>Scalable, future-proof analytics</li>
            </ul>
          </div>
        </div>
      </section>
